...
#undef VK_BACK
#undef VK_TAB
#undef VK_RESERVED_0A
#undef VK_RESERVED_0B
#undef VK_CLEAR
#undef VK_RETURN
#undef VK_SHIFT
#undef VK_CONTROL
...
#undef VK_NUMLOCK
#undef VK_SCROLL
#undef VK_OEMSPECIFIC_92
#undef VK_OEMSPECIFIC_93
#undef VK_OEMSPECIFIC_94
#undef VK_OEMSPECIFIC_95
#undef VK_OEMSPECIFIC_96
#undef VK_LSHIFT
#undef VK_RSHIFT
#undef VK_LCONTROL
#undef VK_RCONTROL
...
#undef VK_RESERVED_B8
#undef VK_RESERVED_B9
#undef VK_OEM_1
#undef VK_OEM_PLUS
#undef VK_OEM_COMMA
#undef VK_OEM_MINUS
...
#undef VK_OEM_2
#undef VK_OEM_3
#undef VK_RESERVED_C1
#undef VK_RESERVED_C2
#undef VK_RESERVED_C3
#undef VK_RESERVED_C4
#undef VK_RESERVED_C5
#undef VK_RESERVED_C6
#undef VK_RESERVED_C7
#undef VK_RESERVED_C8
#undef VK_RESERVED_C9
#undef VK_RESERVED_CA
#undef VK_RESERVED_CB
#undef VK_RESERVED_CC
#undef VK_RESERVED_CD
#undef VK_RESERVED_CE
#undef VK_RESERVED_CF
#undef VK_RESERVED_D0
#undef VK_RESERVED_D1
#undef VK_RESERVED_D2
#undef VK_RESERVED_D3
#undef VK_RESERVED_D4
#undef VK_RESERVED_D5
#undef VK_RESERVED_D6
#undef VK_RESERVED_D7
#undef VK_OEM_4
#undef VK_OEM_5
#undef VK_OEM_6
#undef VK_OEM_7
#undef VK_OEM_8
#undef VK_RESERVED_E0
#undef VK_OEMSPECIFIC_E1
#undef VK_OEM_102
#undef VK_OEMSPECIFIC_E3
#undef VK_OEMSPECIFIC_E4
#undef VK_PROCESSKEY
#undef VK_OEMSPECIFIC_E6
#undef VK_PACKET
#undef VK_OEMSPECIFIC_E9
#undef VK_OEMSPECIFIC_EA
#undef VK_OEMSPECIFIC_EB
#undef VK_OEMSPECIFIC_EC
#undef VK_OEMSPECIFIC_ED
#undef VK_OEMSPECIFIC_EE
#undef VK_OEMSPECIFIC_EF
#undef VK_OEMSPECIFIC_F0
#undef VK_OEMSPECIFIC_F1
#undef VK_OEMSPECIFIC_F2
#undef VK_OEMSPECIFIC_F3
#undef VK_OEMSPECIFIC_F4
#undef VK_OEMSPECIFIC_F5
#undef VK_ATTN
#undef VK_CRSEL
#undef VK_EXSEL
#undef VK_EREOF
